...
def main():
    ...
    plt.scatter(classy_nii, classy_oiii, s = 20, ls = "", color = "slateblue", label = "CLASSY")
    plt.errorbar(classy_nii, classy_oiii, yerr = classy_oiii_err, xerr = classy_nii_err, fmt='none', ecolor= "slateblue")
    plt.scatter(lzlcs_nii, lzlcs_oiii, s = 20, ls = "", color = "salmon", label = "LzLCS")
    plt.errorbar(lzlcs_nii, lzlcs_oiii, yerr = lzlcs_oiii_err, xerr = lzlcs_nii_err, fmt='none', ecolor= "salmon")
    ...
    plt.scatter(classy_sii, classy_oiii, s = 20, ls = "", color = "slateblue")
    plt.errorbar(lzlcs_sii, lzlcs_oiii, yerr = lzlcs_oiii_err, xerr = lzlcs_sii_err, fmt='none', ecolor= "salmon", label = "LzLCS")
    plt.scatter(lzlcs_sii, lzlcs_oiii, s = 20, ls = "", color = "salmon")
    ...
    plt.scatter(classy_oi, classy_oiii, s = 20, ls = "", color = "slateblue")
    plt.errorbar(lzlcs_oi, lzlcs_oiii, yerr = lzlcs_oiii_err, xerr = lzlcs_oi_err, fmt='none', ecolor= "salmon", label = "LzLCS")
    plt.scatter(lzlcs_oi, lzlcs_oiii, s = 20, ls = "", color = "salmon")
